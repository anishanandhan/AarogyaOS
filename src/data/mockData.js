...
export const centres = [
  { id: "phc-001", name: "PHC Tambaram", type: "PHC", block: "Tambaram", healthScore: 34, bedsTotal: 10, bedsOccupied: 8, doctorsOnRoll: 2, doctorsPresent: 0, lastUpdated: "2025-07-01T08:30:00" },
  { id: "phc-002", name: "PHC Kanchipuram North", type: "PHC", block: "Kanchipuram", healthScore: 71, bedsTotal: 12, bedsOccupied: 5, doctorsOnRoll: 3, doctorsPresent: 3, lastUpdated: "2025-07-01T09:00:00" },
  { id: "chc-001", name: "CHC Vellore Central", type: "CHC", block: "Vellore", healthScore: 58, bedsTotal: 30, bedsOccupied: 22, doctorsOnRoll: 6, doctorsPresent: 4, lastUpdated: "2025-07-01T08:45:00" },
  { id: "phc-003", name: "PHC Gudiyatham", type: "PHC", block: "Gudiyatham", healthScore: 82, bedsTotal: 10, bedsOccupied: 3, doctorsOnRoll: 2, doctorsPresent: 2, lastUpdated: "2025-07-01T09:15:00" },
  { id: "phc-004", name: "PHC Arcot", type: "PHC", block: "Arcot", healthScore: 45, bedsTotal: 8, bedsOccupied: 7, doctorsOnRoll: 2, doctorsPresent: 1, lastUpdated: "2025-07-01T08:00:00" },
  { id: "phc-005", name: "PHC Ranipet", type: "PHC", block: "Ranipet", healthScore: 91, bedsTotal: 10, bedsOccupied: 2, doctorsOnRoll: 2, doctorsPresent: 2, lastUpdated: "2025-07-01T09:30:00" },
  { id: "phc-006", name: "PHC Walajah", type: "PHC", block: "Walajah", healthScore: 29, bedsTotal: 8, bedsOccupied: 8, doctorsOnRoll: 1, doctorsPresent: 0, lastUpdated: "2025-07-01T07:45:00" },
  { id: "chc-002", name: "CHC Katpadi", type: "CHC", block: "Katpadi", healthScore: 63, bedsTotal: 25, bedsOccupied: 14, doctorsOnRoll: 5, doctorsPresent: 4, lastUpdated: "2025-07-01T09:00:00" }
];
...
export const ashaWorkers = [
  { id: "asha-001", name: "Lakshmi Devi", centreId: "phc-001", block: "Tambaram", village: "Perungalathur", householdsAssigned: 120, visitsThisWeek: 18, visitsRequired: 20, verifiedVisits: 15, suspiciousVisits: 2, workerScore: 72, lastVisit: "2025-07-01T10:00:00" },
  { id: "asha-002", name: "Sumathi R", centreId: "phc-001", block: "Tambaram", village: "Chitlapakkam", householdsAssigned: 95, visitsThisWeek: 5, visitsRequired: 19, verifiedVisits: 3, suspiciousVisits: 0, workerScore: 28, lastVisit: "2025-06-27T14:00:00" },
  { id: "asha-003", name: "Parvathi K", centreId: "phc-002", block: "Kanchipuram", village: "Uthiramerur", householdsAssigned: 110, visitsThisWeek: 22, visitsRequired: 22, verifiedVisits: 22, suspiciousVisits: 0, workerScore: 98, lastVisit: "2025-07-01T11:30:00" },
  { id: "asha-004", name: "Meenakshi S", centreId: "phc-006", block: "Walajah", village: "Arcot North", householdsAssigned: 88, visitsThisWeek: 21, visitsRequired: 18, verifiedVisits: 8, suspiciousVisits: 11, workerScore: 31, lastVisit: "2025-07-01T09:00:00" },
  { id: "asha-005", name: "Gomathi V", centreId: "phc-003", block: "Gudiyatham", village: "Gudiyatham West", householdsAssigned: 130, visitsThisWeek: 25, visitsRequired: 26, verifiedVisits: 24, suspiciousVisits: 0, workerScore: 94, lastVisit: "2025-07-01T12:00:00" },
  { id: "asha-006", name: "Radha M", centreId: "phc-006", block: "Walajah", village: "Walajah South", householdsAssigned: 102, visitsThisWeek: 0, visitsRequired: 20, verifiedVisits: 0, suspiciousVisits: 0, workerScore: 5, lastVisit: "2025-06-24T08:00:00" }
];

export const visitLogs = [
  { id: "v1", workerId: "asha-001", workerName: "Lakshmi Devi", householdId: "HH-1042", visitType: "ANC Checkup", notes: "Blood pressure measured, iron tablets distributed", photoSubmitted: true, verificationStatus: "VERIFIED", timestamp: "2025-07-01T10:00:00" },
  { id: "v2", workerId: "asha-004", workerName: "Meenakshi S", householdId: "HH-2031", visitType: "Immunization", notes: "Child vaccination done", photoSubmitted: true, verificationStatus: "SUSPICIOUS", timestamp: "2025-07-01T09:00:00", suspicionReason: "Photo metadata does not match reported location" },
  { id: "v3", workerId: "asha-002", workerName: "Sumathi R", householdId: "HH-1155", visitType: "TB Follow-up", notes: "Patient not at home", photoSubmitted: false, verificationStatus: "UNVERIFIED", timestamp: "2025-06-27T14:00:00" },
  { id: "v4", workerId: "asha-003", workerName: "Parvathi K", householdId: "HH-3022", visitType: "Postnatal Care", notes: "Mother and baby healthy, ORS distributed", photoSubmitted: true, verificationStatus: "VERIFIED", timestamp: "2025-07-01T11:30:00" },
  { id: "v5", workerId: "asha-005", workerName: "Gomathi V", householdId: "HH-4011", visitType: "Hypertension Follow-up", notes: "BP tablets refilled, diet counselling done", photoSubmitted: true, verificationStatus: "VERIFIED", timestamp: "2025-07-01T12:00:00" }
];
...
export const labAvailability = {
  "phc-001": { "Blood CBC": true, "Urine Routine": true, "Malaria RDT": false, "Blood Sugar (FBS/PPBS)": true, "HIV Rapid Test": false, "Sputum AFB (TB)": false, "Pregnancy Test": true, "ECG": false, "X-Ray": false, "Haemoglobin": true, lastAudit: "2025-05-28" },
  "phc-002": { "Blood CBC": true, "Urine Routine": true, "Malaria RDT": true, "Blood Sugar (FBS/PPBS)": true, "HIV Rapid Test": true, "Sputum AFB (TB)": true, "Pregnancy Test": true, "ECG": true, "X-Ray": false, "Haemoglobin": true, lastAudit: "2025-06-20" },
  "chc-001": { "Blood CBC": true, "Urine Routine": true, "Malaria RDT": true, "Blood Sugar (FBS/PPBS)": true, "HIV Rapid Test": true, "Sputum AFB (TB)": true, "Pregnancy Test": true, "ECG": true, "X-Ray": true, "Haemoglobin": true, lastAudit: "2025-06-28" },
  "phc-003": { "Blood CBC": true, "Urine Routine": true, "Malaria RDT": true, "Blood Sugar (FBS/PPBS)": true, "HIV Rapid Test": false, "Sputum AFB (TB)": true, "Pregnancy Test": true, "ECG": false, "X-Ray": false, "Haemoglobin": true, lastAudit: "2025-06-15" },
  "phc-004": { "Blood CBC": true, "Urine Routine": false, "Malaria RDT": false, "Blood Sugar (FBS/PPBS)": true, "HIV Rapid Test": false, "Sputum AFB (TB)": false, "Pregnancy Test": true, "ECG": false, "X-Ray": false, "Haemoglobin": true, lastAudit: "2025-05-10" },
  "phc-005": { "Blood CBC": true, "Urine Routine": true, "Malaria RDT": true, "Blood Sugar (FBS/PPBS)": true, "HIV Rapid Test": true, "Sputum AFB (TB)": false, "Pregnancy Test": true, "ECG": true, "X-Ray": false, "Haemoglobin": true, lastAudit: "2025-06-25" },
  "phc-006": { "Blood CBC": false, "Urine Routine": true, "Malaria RDT": false, "Blood Sugar (FBS/PPBS)": false, "HIV Rapid Test": false, "Sputum AFB (TB)": false, "Pregnancy Test": true, "ECG": false, "X-Ray": false, "Haemoglobin": true, lastAudit: "2025-04-30" },
  "chc-002": { "Blood CBC": true, "Urine Routine": true, "Malaria RDT": true, "Blood Sugar (FBS/PPBS)": true, "HIV Rapid Test": true, "Sputum AFB (TB)": true, "Pregnancy Test": true, "ECG": true, "X-Ray": true, "Haemoglobin": true, lastAudit: "2025-06-30" }
};

export const alerts = [
  { id: "a1", severity: "CRITICAL", type: "STOCK_OUT", centreId: "phc-006", centreName: "PHC Walajah", message: "ORS Sachets critically low — 0.7 days remaining at current consumption.", recommendation: "Emergency transfer: 150 sachets from PHC Ranipet (surplus: 380 units)", timestamp: "2025-07-01T06:30:00", dismissed: false },
  { id: "a2", severity: "CRITICAL", type: "DOCTOR_ABSENT", centreId: "phc-006", centreName: "PHC Walajah", message: "Dr. Ravi Shankar absent for 6 consecutive days. Centre has 0 doctors present.", recommendation: "Deploy relief doctor from CHC Katpadi district roster immediately", timestamp: "2025-07-01T07:00:00", dismissed: false },
  { id: "a3", severity: "CRITICAL", type: "BED_CAPACITY", centreId: "phc-006", centreName: "PHC Walajah", message: "Bed occupancy at 100% (8/8). Cannot admit new IPD patients.", recommendation: "Redirect non-critical IPD cases to CHC Katpadi (11 beds available)", timestamp: "2025-07-01T08:00:00", dismissed: false },
  { id: "a4", severity: "CRITICAL", type: "ASHA_FAKE_REPORT", centreId: "phc-006", centreName: "PHC Walajah", message: "ASHA Worker Meenakshi S: 11 suspicious visits flagged. Photo metadata mismatch detected.", recommendation: "Block supervisor to conduct field verification in Arcot North village", timestamp: "2025-07-01T08:30:00", dismissed: false },
  { id: "a5", severity: "HIGH", type: "DOCTOR_ABSENT", centreId: "phc-001", centreName: "PHC Tambaram", message: "Dr. Meena Krishnan absent 4 consecutive days. Centre running 143 patients with 0 doctors.", recommendation: "Urgent: Request emergency deployment from district doctor pool", timestamp: "2025-07-01T07:15:00", dismissed: false },
  { id: "a6", severity: "HIGH", type: "STOCK_OUT", centreId: "phc-001", centreName: "PHC Tambaram", message: "Cotrimoxazole at 1.9 days remaining. Paracetamol at 2.7 days remaining.", recommendation: "Emergency stock transfer from PHC Gudiyatham (Cotrimoxazole: 420 units surplus)", timestamp: "2025-07-01T06:45:00", dismissed: false },
  { id: "a7", severity: "HIGH", type: "FOOTFALL_SURGE", centreId: "phc-001", centreName: "PHC Tambaram", message: "Today's footfall 57% above 7-day average (143 vs avg 91). No doctor present.", recommendation: "Deploy mobile medical unit to PHC Tambaram immediately", timestamp: "2025-07-01T09:00:00", dismissed: false },
  { id: "a8", severity: "HIGH", type: "ASHA_NO_VISIT", centreId: "phc-006", centreName: "PHC Walajah", message: "ASHA Worker Radha M: Zero visits logged in 7 days. Walajah South village unserved.", recommendation: "Supervisor field visit required. Reassign households to Meenakshi S temporarily.", timestamp: "2025-07-01T07:45:00", dismissed: false },
  { id: "a9", severity: "MEDIUM", type: "LAB_AUDIT", centreId: "phc-001", centreName: "PHC Tambaram", message: "Lab audit overdue by 34 days. Only 5/10 tests available.", recommendation: "Schedule audit. Request ECG machine and X-Ray service from district medical store.", timestamp: "2025-07-01T05:00:00", dismissed: false },
  { id: "a10", severity: "MEDIUM", type: "LAB_AUDIT", centreId: "phc-006", centreName: "PHC Walajah", message: "Lab audit overdue by 62 days. Only 2/10 tests available.", recommendation: "Immediate audit required. Centre critically under-equipped for diagnostics.", timestamp: "2025-07-01T05:30:00", dismissed: false },
  { id: "a11", severity: "MEDIUM", type: "STOCK_OUT", centreId: "phc-004", centreName: "PHC Arcot", message: "Paracetamol approaching reorder threshold — 9 days remaining.", recommendation: "Place monthly indent order with district pharmacy this week.", timestamp: "2025-07-01T07:30:00", dismissed: false }
];
